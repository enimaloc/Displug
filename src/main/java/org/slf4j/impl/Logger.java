...
public class Logger implements org.slf4j.Logger {
    ...
    private final LoggerFactory source;
    ...
    protected String renderLevel(int level) {
        return switch (level) {
            ...
            case LOG_LEVEL_CONSOLE -> "CONSOLE";
    ...
    private String getColorByLevel(int level) {
        return switch (level) {
            case LOG_LEVEL_TRACE -> Logger.ANSI_CYAN;
            case LOG_LEVEL_DEBUG -> Logger.ANSI_PURPLE;
            case LOG_LEVEL_INFO -> Logger.ANSI_BLUE;
            case LOG_LEVEL_WARN -> Logger.ANSI_YELLOW;
            case LOG_LEVEL_ERROR -> Logger.ANSI_RED;
            case LOG_LEVEL_CONSOLE -> Logger.ANSI_GREEN;
            default -> Logger.ANSI_WHITE;
        };
    }
    ...
    protected boolean isLevelEnabled(int logLevel) {
        return switch (logLevel) {
            case Logger.LOG_LEVEL_TRACE -> this.traceLevel;
            case Logger.LOG_LEVEL_DEBUG -> this.debugLevel;
            case Logger.LOG_LEVEL_INFO -> this.infoLevel;
            case Logger.LOG_LEVEL_WARN -> this.warnLevel;
            case Logger.LOG_LEVEL_ERROR -> this.errorLevel;
            default -> false;
        };
    }
